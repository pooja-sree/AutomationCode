...
@AndroidFindBy(accessibility = "Service events and inspections")
    public WebElement ServiceEventListButton;
...
//        "android.view.ViewGroup/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup[1]")
//public WebElement serviceEventSearch;

@AndroidFindBy(xpath = "//android.widget.TextView[@text=\"  Services and Inspections\"]")
public WebElement serviceEventSearch1;
